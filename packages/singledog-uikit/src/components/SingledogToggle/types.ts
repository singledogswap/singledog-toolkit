...
export type SingledogToggleTheme = {
...
export interface SingledogToggleProps extends InputHTMLAttributes<HTMLInputElement> {
  scale?: Scales;
  checked?: boolean;
}
...
export const scaleKeys = {
  singledogSize: "singledogSize",
  travelDistance: "travelDistance",
  toggleHeight: "toggleHeight",
  toggleWidth: "toggleWidth",
  singledogThickness: "singledogThickness",
  singledogTwoOffset: "singledogTwoOffset",
  singledogThreeOffset: "singledogThreeOffset",
  butterTop: "butterTop",

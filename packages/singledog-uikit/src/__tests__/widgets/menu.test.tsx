...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c3:hover:not(:disabled):not(.singledog-button--disabled):not(.singledog-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c3:active:not(:disabled):not(.singledog-button--disabled):not(.singledog-button--disabled) {
      opacity: 0.85;
    ...
    .c8:hover:not(:disabled):not(.singledog-button--disabled):not(.singledog-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c8:active:not(:disabled):not(.singledog-button--disabled):not(.singledog-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
    ...
    .c24:hover:not(:disabled):not(.singledog-button--disabled):not(.singledog-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c24:active:not(:disabled):not(.singledog-button--disabled):not(.singledog-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
      ...
      >
        ...
        >
          ...
          >
            ...
            <a
              aria-label="Singledog home page"
              class="c6"
              href="/"
            >
              <svg
